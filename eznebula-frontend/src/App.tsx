// EZNebula main connection window — matches anyn2n layout exactly
    ...
    <div className="h-screen bg-background p-3 flex flex-col gap-2">
      ...
      <div className="flex flex-col gap-3">
        <div className="w-full max-w-md mx-auto">
          ...
          <Input placeholder="http://server:52346" value={serverUrl} onChange={e => setServerUrl(e.target.value)} disabled={!idle} className="h-7 text-xs text-center"/>
        </div>
